...
print("For replacing sections in DATA.bin")

if len(sys.argv) != 3:
    print("USAGE: %s <section number> <replacement FILENAME>" % str(sys.argv[0]))
    exit()
    
sectionnumber = int(sys.argv[1])
...
print("Loading Data.bin searching for section %d" % ( sectionnumber ))
...
replace_n_write(vol_idx, bpatch, size)
